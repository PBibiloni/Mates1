...
```{r}
curve(0.322 * x^0.4, 40, 120, xlab = 'Pes [kg]', ylab = 'Alçada [m]')
```
...
Si ho feim de la següent forma no és correcte ja que l'eix vertical ha de representar la variable $y$, no la variable $Y$:
