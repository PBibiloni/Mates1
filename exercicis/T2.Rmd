...
Si ho feim de la següent forma no és correcte ja que l'eix vertical ha de representar la variable $y$, no la variable $Y$. De fet, l'eix vertical està en escala lineal!:
...
```{r}
curve(450.29*0.983^x,0,150,col="red",xlab="Temps [min]",  
    ylab="Conc. [mg/100 ml]")
...
```{r}
curve(10^2.07061*x^{-0.41436},0,150,col="red",xlab="Temps [min]",  
    ylab="Conc. [mg/100 ml]")
points(x=df$temps, y=df$concentracio)
```
...
Visualitzarem les dades en una gràfica lineal, semilog i loglog:
